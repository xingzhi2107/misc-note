...
*** :nth-child() vs :nth-of-type()
    =:nth-child()= 应该是很好理解的，就是“第几个子元素”的意思。然而，实际上并非那么简单！到底是哪些元素中的 =Tn+X= 个呢？我们之间上结果：
...
*** Cascading order
    ...
    所以，四个因素是：来源，重要性，特殊性以及先后顺序。但是“来源”于“重要性”在这里却有一个“小插曲”，当我们只考虑二者的时候，按照W3C的说法，应该很容易得出这样的顺序表（越靠前越先采用）：
